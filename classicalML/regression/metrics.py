...
def root_mean_squared_log_error(Y_predicted,
    ...
    Y_predicted = np.array(Y_predicted)
    Y_actual = np.array(Y_actual)
    return np.sqrt(np.mean((np.log(Y_predicted + 1) - np.log(Y_actual + 1)) ** 2))
...
def root_median_squared_log_error(Y_predicted,
    ...
    Y_predicted = np.array(Y_predicted)
    Y_actual = np.array(Y_actual)
    return np.sqrt(np.median((np.log(Y_predicted + 1) - np.log(Y_actual + 1)) ** 2))
...
def mean_absolute_log_error(Y_predicted,
    ...
    Y_predicted = np.array(Y_predicted)
    Y_actual = np.array(Y_actual)
    return np.mean(np.abs((np.log(Y_predicted + 1) - np.log(Y_actual + 1))))
...
def median_absolute_log_error(Y_predicted,
    ...
    Y_predicted = np.array(Y_predicted)
    Y_actual = np.array(Y_actual)
    return np.median(np.abs((np.log(Y_predicted + 1) - np.log(Y_actual + 1))))
